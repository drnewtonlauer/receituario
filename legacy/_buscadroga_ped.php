...
$sql = "SELECT * FROM medicamento_ped WHERE nome LIKE '%".$valor."%' order by nome LIMIT 20";
...
<div class="list-group" style="font-size:12px;padding-bottom:0px;margin-bottom:0px; ">
...
while ($rdroga = mysqli_fetch_array($result)) {
	...
	onclick="location.href=\'receituario_ped.php?id2='.$rdroga['id'].'\'">'.$rdroga['nome'].'</button>';}
